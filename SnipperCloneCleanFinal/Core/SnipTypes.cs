...
namespace SnipperCloneCleanFinal.Core
{
    ...
    {
        public SnipMode OldMode { get; }
        public SnipMode NewMode { get; }

        public SnipModeChangedEventArgs(SnipMode oldMode, SnipMode newMode)
        {
            OldMode = oldMode;
            NewMode = newMode;
        }
    ...
    public class CellSelectionChangedEventArgs : EventArgs
    {
        ...
        public CellSelectionChangedEventArgs(string oldAddress, string newAddress)
        {
